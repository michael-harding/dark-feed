    ...
    <div className="flex-1 bg-background overflow-hidden flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto">
        <article className="max-w-3xl mx-auto p-8">
          ...
          {/* Content */}
          <div 
            className="prose prose-invert max-w-none prose-headings:text-foreground prose-p:text-foreground prose-strong:text-foreground prose-a:text-primary hover:prose-a:text-primary/80 prose-code:text-foreground prose-pre:bg-muted prose-blockquote:text-muted-foreground prose-blockquote:border-l-primary"
